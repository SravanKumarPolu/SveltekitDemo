...
<div class="navbar  px-10 fixed top-0 left-0 right-0 z-50 bg-base-100 shadow-lg">
...
<div class="grid grid-cols-2 w-[28rem] gap-2 justify-items-center items-center">
...
<div class="flex gap-1 justify-center items-center ">
      <div class="flex gap-1 justify-center items-center">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="24" height="26">
  <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.29 5.064c.69.48 1.63.48 2.32 0L21 8M5 7h14a2 2 0 012 2v7a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2z" />
</svg>
<span>&#58;<span>
