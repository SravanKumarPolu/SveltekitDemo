...
<div class="flex-grow">
    <div class="text-sm grid grid-cols-2 gap-2">
        <!-- Customers Section (First row, first column) -->
        ...
        <!-- Carriers Section (First row, second column) -->
        <div class="flex-grow relative group">
            <div
                class="truncate max-w-xs"
                style="max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
        ...
        <!-- Shipper Groups Section (Second row, first column) -->
        <div class="flex-grow relative group">
            <div
                class="truncate max-w-xs"
                style="max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
        ...
        <!-- Shippers Section (Second row, second column) -->
        <div class="flex-grow relative group">
            <div
                class="truncate max-w-xs"
                style="max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
        ...
        <!-- Date Section (Third row, spanning two columns) -->
        <div class="flex-grow relative group col-span-2">
            <div
                class="truncate max-w-full"
                style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
                title={appliedFilters.dateTooltip}
            >
                <strong>Date:</strong> {appliedFilters.date}
            </div>
            <div
                class="absolute left-0 top-full mt-1 hidden group-hover:block bg-gray-800 text-white p-2 rounded shadow-lg max-w-full z-10"
            >
                <ul class="text-sm">
                    {appliedFilters.date}
                </ul>
        ...
        <!-- Currency Section (Fourth row, spanning two columns) -->
        <div class="flex-grow relative group col-span-2">
            <div
                class="truncate max-w-full"
                style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
            ...
            >
                <strong>Currencies:</strong> {appliedFilters.selectedCurrencies}
            </div>
            <div
                class="absolute left-0 top-full mt-1 hidden group-hover:block bg-gray-800 text-white p-2 rounded shadow-lg max-w-full z-10"
            >
