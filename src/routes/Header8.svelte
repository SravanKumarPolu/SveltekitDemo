...
<div class="text-sm flex flex-col gap-1">
  <div class="flex-grow relative group">
    ...
    <div class="absolute left-0 top-full mt-1 hidden group-hover:block bg-gray-800 text-white p-2 rounded shadow-lg max-w-xs z-10">
      <!-- Full content inside tooltip -->
      <ul class="text-sm">
